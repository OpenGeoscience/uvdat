# Generated by Django 4.1 on 2023-10-09 19:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'dataset_type',
                    models.CharField(
                        choices=[('VECTOR', 'Vector'), ('RASTER', 'Raster'), ('CHART', 'Chart')],
                        max_length=6,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'data_source',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to='core.vectordatasource'
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('connected_edges', models.ManyToManyField(to='core.networkedge')),
                (
                    'dataset',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='core.networknode'),
        ),
        migrations.AddField(
            model_name='networkedge',
            name='dataset',
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name='derived_regions', to='core.originalregion'
                    ),
                ),
            ],
        ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=('city', 'name'), name='unique-original-region-name'
            ),
        ),
        migrations.AddConstraint(
            model_name='derivedregion',
            constraint=models.UniqueConstraint(
                fields=('city', 'name'), name='unique-derived-region-name'
            ),
        ),
    ]
