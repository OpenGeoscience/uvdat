# Generated by Django 4.1 on 2023-10-12 14:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='original_files', to='core.dataset')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='chart',
            name='city',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='charts', to='core.city'),
        ),
